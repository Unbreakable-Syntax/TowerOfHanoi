...
namespace TowerOfHanoi
{
    public partial class TowerForm : Form
    {
        ...
        private readonly int radius = 5;  // Modify value to alter curvature
        static int previousDiskAmount = 2;
        ...
        {           
            if (freshGame == false)
            {
                diskAmount.ValueChanged -= DiskAmount_ValueChanged;
                ...
                diskAmount.Value = previousDiskAmount;
                diskAmount.ValueChanged += DiskAmount_ValueChanged; return;
            }
            if (autoSolveOn == true)
            {
                diskAmount.ValueChanged -= DiskAmount_ValueChanged;
        ...
        private async void ResetPuzzle()
        {
            ...
            draggedDisk = null; ClearCopiedDisk();
            ...
            d1.MouseEnter -= D1_MouseEnter;
            d1.MouseLeave -= D1_MouseLeave;
            d1.Visible = true;
            ...
            d2.MouseEnter -= D1_MouseEnter;
            d2.MouseLeave -= D1_MouseLeave;
            d2.Visible = true;
            ...
            if (d3.Parent != null)
            {
                ...
                d3.MouseEnter -= D1_MouseEnter;
                d3.MouseLeave -= D1_MouseLeave;
                d3.Visible = true;
            ...
            if (d4.Parent != null)
            {
                ...
                d4.MouseEnter -= D1_MouseEnter;
                d4.MouseLeave -= D1_MouseLeave;
                d4.Visible = true;
            ...
            if (d5.Parent != null)
            {
                ...
                d5.MouseEnter -= D1_MouseEnter;
                d5.MouseLeave -= D1_MouseLeave;
                d5.Visible = true;
            ...
            if (d6.Parent != null && d6.Visible == true)
            {
                ...
                d6.MouseEnter -= D1_MouseEnter;
                d6.MouseLeave -= D1_MouseLeave;
                d6.Visible = true;
            ...
            if (d7.Parent != null)
            {
                ...
                d7.MouseEnter -= D1_MouseEnter;
                d7.MouseLeave -= D1_MouseLeave;
                d7.Visible = true;
            ...
            if (d8.Parent != null)
            {
                ...
                d8.MouseEnter -= D1_MouseEnter;
                d8.MouseLeave -= D1_MouseLeave;
                d8.Visible = true;
            ...
            if (d9.Parent != null)
            {
                ...
                d9.MouseEnter -= D1_MouseEnter;
                d9.MouseLeave -= D1_MouseLeave;
                d9.Visible = true;
            ...
            if (d10.Parent != null)
            {
                ...
                d10.MouseEnter -= D1_MouseEnter;
                d10.MouseLeave -= D1_MouseLeave;
                d10.Visible = true;
            ...
            if (d11.Parent != null)
            {
                ...
                d11.MouseEnter -= D1_MouseEnter;
                d11.MouseLeave -= D1_MouseLeave;
                d11.Visible = true;
        ...
        public void EnableMouseInteractionForTopmostDisk(TableLayoutPanel rod)
        {
            ...
            if (topDisk != null)
            {
                ...
                topDisk.MouseDown += D1_MouseDown;
                topDisk.MouseEnter -= D1_MouseEnter;
                topDisk.MouseEnter += D1_MouseEnter;
                topDisk.MouseLeave -= D1_MouseLeave;
                topDisk.MouseLeave += D1_MouseLeave;
            }
        }
        ...
        private void TowerForm_DragDrop(object sender, DragEventArgs e)
        {
            if (draggedDisk != null)
            {
                if (copiedDisk != null) { ClearCopiedDisk(); }
        ...
        private void TowerForm_DragOver(object sender, DragEventArgs e)
        {
            ...
            if (copiedDisk != null && showDiskDragBox.Checked == false) 
            { copiedDisk.Visible = true; }
            else if (copiedDisk != null && showDiskDragBox.Checked == true) 
            { copiedDisk.Visible = false; copiedDisk.Enabled = false; }
        }
        ...
        private void D1_MouseEnter(object sender, EventArgs e) { Cursor = Cursors.Hand; }

        private void D1_MouseLeave(object sender, EventArgs e) { Cursor = Cursors.Default; }

        private void PrintCurrentRod(TableLayoutPanel rod)
        {
            string rodName = "";
        ...
        private void PrintEmpty(TableLayoutPanel rod)
        {            
            string rodName = "";
            if (rod == fromRod) { rodName = "Starting"; }
            else if (rod == auxRod) { rodName = "Auxiliary"; }
            ...
            if (selectedDisk != null)
            {
                ...
                if (e.KeyCode == Keys.Right)
                {
                    ...
                    {                   
                        ...
                        else { InvalidPrint(); selectedDisk.Visible = true; ClearCopiedDisk(); return; }                       
                        selectedDisk.Visible = true; ClearCopiedDisk();
                        selectedDisk = null; ++moves;
        ...
        {
            // Get the value of the disk being moved
        ...
        private void ClearCopiedDisk()
        {
            copiedDisk.Visible = false;
            copiedDisk.Enabled = false;
            copiedDisk.Text = "";
        ...
        {
            if (e.KeyCode == Keys.Up || e.KeyCode == Keys.Down || e.KeyCode == Keys.Left || e.KeyCode == Keys.Right) { e.Handled = true; }
        }
        ...
        private void Rod1_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                if (peg == rod1) { FromRod_Transfer(); }
                else if (peg == rod2) { AuxRod_Transfer(); }
                else if (peg == rod3) { ToRod_Transfer(sender, e); }
            }
        }
        ...
        private void ToRod_Panel_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (location != null)
            {
                if (location == fromRod_Location) { FromRod_Transfer(); }
                else if (location == auxRod_Panel) { AuxRod_Transfer(); }
                else if (location == toRod_Panel) { ToRod_Transfer(sender, e); }
            }
        }
